...
const sendPasswordResetEmail = async (otp, receiverEmailString) => {
	...
	const message = `Hi! There, Someone has attempted to reset your password to our website CodeRoyale.
	...
	const mailOptions = {
		...
		subject: 'Reset password to CodeMailer',
		html: message
	}
